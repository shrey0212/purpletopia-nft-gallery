...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary/50 border-t border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/collections" className="text-gray-400 hover:text-purple-400">Collections</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2024 PurpleTopia. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
